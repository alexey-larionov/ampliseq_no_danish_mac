...
# The script requires that call rates are
#  - >70% for variants and
#  - > 66.5% for samples (relaxed to keep 1 sample that would be removed at 70%)
# This is less stringent than might had been filtered earlier in this dataset (??%)
